...
class ReportBarangMasukController extends Controller
{
    ...
    function reportBarangMasuk(Request $request)
    {
        if (!\AppHelper::instance()->getpermision(6,"R"))
        {
        ...
        return $this->resBarangMasuk($periode_start,$periode_end);
    }

    function resBarangMasuk($periode_start,$periode_end)
    {
        $strSQL="
        ...
        where type='Mutasi Masuk' and tanggal between '".$periode_start."' and '".$periode_end."'
        order by mutasi.id
        ";
