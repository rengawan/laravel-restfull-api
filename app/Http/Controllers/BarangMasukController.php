...
class BarangMasukController extends Controller
{
    ...
    public function index()
    {
        ...
        if (!\AppHelper::instance()->getpermision(3,"R"))
        {
            return response()->json(['error' => 'Permision Denied'], 403);
        }


        $data=Mutasi::where('type','Mutasi Masuk')->get();
    ...
    public function getDataByUser()
    {
        ...
        $data=Mutasi::where('type','Mutasi Masuk')->where('created_by',auth()->id())->get();
        return response()->json($data,200);
    }
    ...
    public function store(Request $request)
    {
            ...
            if (!\AppHelper::instance()->getpermision(3,"C"))
            {
                return response()->json(['error' => 'Permision Denied'], 403);
            }
    ...
    {
        //
        if (!\AppHelper::instance()->getpermision(3,"U"))
            {
                return response()->json(['error' => 'Permision Denied'], 403);
            }
    ...
    {
        if (!\AppHelper::instance()->getpermision(3,"D"))
        {
            return response()->json(['error' => 'Permision Denied'], 403);
        }
        try {
